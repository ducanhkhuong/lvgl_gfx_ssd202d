	...
	lv_obj_set_style_text_font(ui->screen_FirstBoot_HomeController_scanHC_Header, &lv_font_montserrat_48, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_FirstBoot_HomeController_scanHC_btn_Previous, &lv_font_montserrat_40, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_FirstBoot_HomeController_scanHC_btn_Next, &lv_font_montserrat_40, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_FirstBoot_HomeController_scanHC_btn_Addmanual, &lv_font_montserrat_40, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->screen_FirstBoot_HomeController_scanHC_label_FindingHC, &lv_font_montserrat_40, LV_PART_MAIN|LV_STATE_DEFAULT);
